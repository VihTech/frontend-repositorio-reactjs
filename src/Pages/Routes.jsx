...
import { CadastrarObras } from './Cadastrar Obras'
...
const RotasExistente = props => (
    <main>
        <Routes>
            ...
            <Route  exact path="/Cadastrar Obras" element={<CadastrarObras/>}></Route>
            <Route  exact path="/Cadastrar Usuario" element={<CadastrarUsuario/>}></Route>
